      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.a
            ...
            className="p-8 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100"
          >
          ...
          <motion.a
            ...
            whileTap={{ scale: 1 }}
            transition={{ type: "spring", stiffness: 400, damping: 10 }}
            className="p-8 rounded-xl bg-gradient-to-br from-pink-50 to-purple-50 border border-pink-100"
          >
